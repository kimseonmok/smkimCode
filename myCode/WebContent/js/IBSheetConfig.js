...
function init_sheet(sheet_obj)
{
    ...
    {    
	    ...
	    SetSheetFontName         ("NanumGothic");                //글자체, Default:굴림체
	    SetHeaderRowHeight       (32    );                //해더 행 높이, Default:26
	    SetSheetFontSize         (13    );                //글자크기, Default:9
	    SetDataRowHeight         (26    );                //데이터 행 높이, Default:20
